...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO tb_category (category_name, category_image) VALUES (?, ?)";
...
<div class="container mx-auto my-8">
  <h2 class="text-3xl font-bold mb-4">Create Category</h2>
  <form action="" method="post" enctype="multipart/form-data" class="max-w-md bg-white p-6 rounded-md shadow-md">
    ...
    <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600">Create Category</button>
  </form>
</div>
